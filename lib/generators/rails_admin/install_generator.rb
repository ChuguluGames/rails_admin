...
module RailsAdmin
  class InstallGenerator < Rails::Generators::Base
    ...
    def install
      ...
      gsub_file Rails.root.join("app/controllers/#{model_name.pluralize}/omniauth_callbacks_controller.rb"), /User\.find_for_open_id/, "#{model_name.camelize.pluralize}.find_for_open_id"
